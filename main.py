...
pianop=pygame.image.load("assets/GAME.png")

Ap=pygame.image.load("assets/A.png")
Bp=pygame.image.load("assets/B.png")
Cp=pygame.image.load("assets/C.png")
Dp=pygame.image.load("assets/D.png")
Ep=pygame.image.load("assets/E.png")
Fp=pygame.image.load("assets/F.png")
Gp=pygame.image.load("assets/G.png")
Amajorp=pygame.image.load("assets/AMAJOR.png")
Cmajorp=pygame.image.load("assets/CMAJOR.png")
Dmajorp=pygame.image.load("assets/DMAJOR.png")
Fmajorp=pygame.image.load("assets/FMAJOR.png")
Gmajorp=pygame.image.load("assets/GMAJOR.png")

awav=pygame.mixer.Sound("assets/a.wav")
swav=pygame.mixer.Sound("assets/s.wav")
dwav=pygame.mixer.Sound("assets/d.wav")
fwav=pygame.mixer.Sound("assets/f.wav")
gwav=pygame.mixer.Sound("assets/g.wav")
hwav=pygame.mixer.Sound("assets/h.wav")
jwav=pygame.mixer.Sound("assets/j.wav")
wwav=pygame.mixer.Sound("assets/w.wav")
ewav=pygame.mixer.Sound("assets/e.wav")
twav=pygame.mixer.Sound("assets/t.wav")
ywav=pygame.mixer.Sound("assets/y.wav")
uwav=pygame.mixer.Sound("assets/u.wav")
...
def register():
    global manager  # Change: Make sure we're referring to the global manager
    manager = pygame_gui.UIManager((1280, 720))  # Change: Reset manager for each screen
...
def login():
    ...
    while True:
        ...
        if username and password:
            ...
            if input_login:
                show_continue = True
                show_failed = False  # Change: Set login_state to 'success' if login is successful
            else:
                show_failed = True
                show_continue = False  # Change: Set login_state to 'failed' if login fails
...
def main_menu():
    while True:
        ...
        REGISTER_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 250), 
...
# logging.debug("Game loop running")
