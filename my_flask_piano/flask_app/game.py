...
BG = pygame.image.load("flask_app/static/assets/Background.png")
pianop = pygame.image.load("flask_app/static/assets/GAME.png")

Ap = pygame.image.load("flask_app/static/assets/A.png")
Bp = pygame.image.load("flask_app/static/assets/B.png")
Cp = pygame.image.load("flask_app/static/assets/C.png")
Dp = pygame.image.load("flask_app/static/assets/D.png")
Ep = pygame.image.load("flask_app/static/assets/E.png")
Fp = pygame.image.load("flask_app/static/assets/F.png")
Gp = pygame.image.load("flask_app/static/assets/G.png")
Amajorp = pygame.image.load("flask_app/static/assets/AMAJOR.png")
Cmajorp = pygame.image.load("flask_app/static/assets/CMAJOR.png")
Dmajorp = pygame.image.load("flask_app/static/assets/DMAJOR.png")
Fmajorp = pygame.image.load("flask_app/static/assets/FMAJOR.png")
Gmajorp = pygame.image.load("flask_app/static/assets/GMAJOR.png")

awav = pygame.mixer.Sound("flask_app/static/assets/a.wav")
swav = pygame.mixer.Sound("flask_app/static/assets/s.wav")
dwav = pygame.mixer.Sound("flask_app/static/assets/d.wav")
fwav = pygame.mixer.Sound("flask_app/static/assets/f.wav")
gwav = pygame.mixer.Sound("flask_app/static/assets/g.wav")
hwav = pygame.mixer.Sound("flask_app/static/assets/h.wav")
jwav = pygame.mixer.Sound("flask_app/static/assets/j.wav")
wwav = pygame.mixer.Sound("flask_app/static/assets/w.wav")
ewav = pygame.mixer.Sound("flask_app/static/assets/e.wav")
twav = pygame.mixer.Sound("flask_app/static/assets/t.wav")
ywav = pygame.mixer.Sound("flask_app/static/assets/y.wav")
uwav = pygame.mixer.Sound("flask_app/static/assets/u.wav")

manager = pygame_gui.UIManager((1280, 720))
clock = pygame.time.Clock()

def get_font(size):
    return pygame.font.Font("flask_app/static/assets/font.ttf", size)

def capture_screen():  # New function to capture the Pygame display
    screen = pygame.display.get_surface()
    image_bytes = io.BytesIO()
    pygame.image.save(screen, image_bytes)
    image_bytes.seek(0)
...
def main_menu():
    while True:
        ...
        REGISTER_BUTTON = Button(image=pygame.image.load("flask_app/static/assets/Options Rect.png"), pos=(640, 250), 
                            text_input="REGISTER", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("flask_app/static/assets/Play Rect.png"), pos=(640, 400), 
                            text_input="LOGIN", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("flask_app/static/assets/Quit Rect.png"), pos=(640, 550), 
...
# Start the Pygame game in a separate thread
...
def frame():
    ...
    pygame.image.save(screen, image_bytes)
    image_bytes.seek(0)
    return Response(image_bytes.read(), mimetype='image/png')
